...
char *test_create()
{
	...
	mu_assert(array != NULL, "DArray_create is failed.");
	mu_assert(array->contents != NULL, "contents are wrong in darray.");
	mu_assert(array->end == 0, "end isn't at the right spot.");
	mu_assert(array->element_size == sizeof(int), "element size is wrong.");
	mu_assert(array->max == 100, "worng max length on initial size.");
...
char *test_get()
{
	...
	mu_assert(DArray_get(array, 1) == val2, "Wrong second vvalue.");
